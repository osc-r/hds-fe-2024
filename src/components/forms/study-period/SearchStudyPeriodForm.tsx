...
export type SearchStudyPeriodFormType = SearchNonAcademicActivityDto;

const FORM_COMPONENTS = (
  menu1: Menu
): FormComponent<SearchStudyPeriodFormType>[] => [
  {
    name: "academicTerm",
    label: "ภาคเรียน",
    type: "SELECT",
...
const SearchStudyPeriodForm = (
  props: FormProps<SearchStudyPeriodFormType> & {
    termOptions: {
      label: string;
      value: string;
    }[];
  ...
  const methods = useForm<SearchStudyPeriodFormType>();
...
export default SearchStudyPeriodForm;
